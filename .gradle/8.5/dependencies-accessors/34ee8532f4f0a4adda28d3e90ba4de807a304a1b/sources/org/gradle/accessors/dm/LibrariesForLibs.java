...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class KotlinLibraryAccessors extends SubDependencyFactory {
         ...
         * with versionRef 'kotlin'.
            ...
            /**
             * Creates a dependency provider for testJunit (org.jetbrains.kotlin:kotlin-test-junit)
         * with versionRef 'kotlin'.
             * This dependency was declared in catalog libs.versions.toml
             */
    ...
    public static class KtorLibraryAccessors extends SubDependencyFactory {
        ...
        public KtorLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for serverCore (io.ktor:ktor-server-core-jvm)
         * with versionRef 'ktor'.
            ...
            /**
             * Creates a dependency provider for serverNetty (io.ktor:ktor-server-netty-jvm)
         * with versionRef 'ktor'.
             * This dependency was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Creates a dependency provider for serverTestHost (io.ktor:ktor-server-test-host-jvm)
         * with versionRef 'ktor'.
             * This dependency was declared in catalog libs.versions.toml
             */
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: kotlin (2.2.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: ktor (3.2.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: logback (1.5.18)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
